...
module.exports = class Inception {
  ...
  // runAsyncCommand(command, silent = true, maxBuffer = 1024 * 500) {
  //   return new Promise((resolve, reject) => {
  //     exec(command, { maxBuffer, cwd: this.path }, (err, stdout, stderr) => {
  //       if (!silent) {
  ...
  // runAsyncCommandLol(command, silent = true, maxBuffer = 1024 * 500) {
  //   return new Promise((resolve, reject) => {
